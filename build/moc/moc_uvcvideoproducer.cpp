...
#include "../../inc/uvcvideoproducer.h"
...
void UvcVideoProducer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (UvcVideoProducer::*)(QAbstractVideoSurface * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UvcVideoProducer::surfaceChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (UvcVideoProducer::*)(UvcAcquisition * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UvcVideoProducer::uvcChanged)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject UvcVideoProducer::staticMetaObject = {
